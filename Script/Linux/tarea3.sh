...
// Las zonas localhost, loopback y empty ya vienen definidas
// en named.rfc1912.zones — NO se repiten aquí para evitar
// el error "already exists previous definition"
